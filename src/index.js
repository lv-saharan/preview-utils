 ...
 */
export const imageToBase64 = (image, type = "image/png", quality = 0.8) => {
...
export const blobToFile = (
  blob,
  fileName,
  { contentType, lastModified = Date.now() } = {}
) => {
...
export const base64ToFile = (
  ...
  return (
    blob &&
    blobToFile(blob, fileName, { type: contentType ?? blob.type, lastModified })
  );
};
...
export const createThumb = async (
  ...
  if (!width || width < 0) width = rawWidth;
  if (!height || height < 0) height = rawHeight;
